...
def get_string_article(url):
    ...
    for head,data in zip(headline,containers):
        articles.append(word_drop(head.text) +" "+ word_drop(data.text))
    return articles
